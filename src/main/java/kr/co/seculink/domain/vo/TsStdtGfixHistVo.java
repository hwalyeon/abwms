...
/**
 * ts_stdt_gfix_hist Value Object
 */
public class TsStdtGfixHistVo implements Serializable {
	...
	/**
	 * Get bmi_val BMI_값 character(18)
	 * @Return String bmiVal
	 */
	...
	/**
	 * Set bmi_val BMI_값 character(18)
	 * @Param String bmiVal
	 */
	public void setBmiVal(String bmiVal) {
		this.bmiVal = bmiVal;
	}
	/**
