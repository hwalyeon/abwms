...
/**
 * tt_strs_judg_stss Value Object
 */
 @ToString
public class TtStrsJudgStssVo implements Serializable {
	 ...
	 * @Return String strsTypeCd
	 */
	public String getStrsTypeCd() {
		return this.strsTypeCd;
	}
	
	/**
	 * Set strs_type_cd 스트레스_유형_코드 character varying(20)
	 * @Param String strsTypeCd
	 */
	public void setStrsTypeCd(String strsTypeCd) {
