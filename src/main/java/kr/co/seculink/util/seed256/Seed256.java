package kr.co.seculink.util.seed256;

public class Seed256 {
	public void setKey (String key) throws Exception
	{
		int intKeyLen = key.length();
		
		if (intKeyLen != 32)
		{
			throw new Exception("Key length is must be 32 byte currunt [" + intKeyLen + "]" + key);
		}
	...
	private Boolean ENDIAN = BIG; // Java virtual machine uses big endian as a default
	...
	public void SeedEncrypt (byte pbData[], int pdwRoundKey[], byte outData[]) {
		int L0[] = new int[1];
		int L1[] = new int[1];
		int R0[] = new int[1];
		int R1[] = new int[1];
	...
	public void SeedDecrypt (byte pbData[], int pdwRoundKey[], byte outData[]) {
		int L0[] = new int[1];
		int L1[] = new int[1];
		int R0[] = new int[1];
		int R1[] = new int[1];
	...
	private void EncRoundKeyUpdate0 (int K[], int A[], int B[], int C[], int D[], int E[], int F[], int G[], int H[], int Z, int rot) {
		int T0;
		int T00, T11;
	...
	private void EncRoundKeyUpdate1 (int K[], int A[], int B[], int C[], int D[], int E[], int F[], int G[], int H[], int Z, int rot) {
		int T0;
		int T00, T11;
	...
	public void SeedRoundKey (int pdwRoundKey[], byte pbUserKey[]) {
		int A[] = new int[1];
		int B[] = new int[1];
		int C[] = new int[1];
		int D[] = new int[1];
	...
	public int KEY_SIZE = 48;
	public int TEXT_SIZE = 16;

	public byte[] SeedEncrypt (byte[] password) {
	...
	public byte[] SeedEncrypt (String password) {
		return SeedEncrypt (password.getBytes ());
	}

	public String Decrypt (byte[] hash) {
	...
	public String encrypt (String password) {
		...
		if(password.length () == 1) {
			...
			for (byte hash : result) {
				...
				tempStr = Integer.toHexString (0xff & hash);
				resultHash += tempStr.length() == 1 ? "0" + tempStr : tempStr;
			}
			return resultHash;
		}
	}
