...
/**
 * USER_FCM Value Object
 */
public class UserFcmVo implements Serializable {

	/* FCM_TOKN FCM_토큰 varchar(255) */
	...
	/**
	 * Get FCM_TOKN FCM_토큰 varchar(255)
	 * @Return String fcmTokn
	 */
	public String getFcmTokn() {
		return this.fcmTokn;
	}
	
	/**
	 * Set FCM_TOKN FCM_토큰 varchar(255)
	 * @Param String fcmTokn
	 */
	public void setFcmTokn(String fcmTokn) {
		this.fcmTokn = fcmTokn;
	}
	/**
