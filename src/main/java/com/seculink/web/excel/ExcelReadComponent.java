package com.seculink.web.excel;
...
public class ExcelReadComponent {
    ...
    public <T> List<T> readExcelToList(final MultipartFile multipartFile, final Function<Row, T> rowFunc) throws IOException, InvalidFormatException {
