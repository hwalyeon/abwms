...
public class RSA2048EncUtil {
     ...
     * @throws SysException 
     */
    static HashMap<String, String> createKeypairAsString() throws SysException {
     ...
     * @throws SysException 
     */
    static String encrypt(String plainData, String stringPublicKey) throws SysException {
     ...
     * @throws SysException 
     */
    static String decrypt(String encryptedData, String stringPrivateKey) throws SysException {
    ...
    public static void main(String[] args) {
        ...
        String plainText = "플레인 텍스트 ++ Plain Text";
