    ...
    methods:
    {
        ...
        initGrid: function()
        {
            ...
            [
                ...
                {name: "calEatQty"    , index: "calEatQty"    , label: "칼로리 섭취/일"          , width: 80 , align: "right"  ,fixed:true},
                {name: "calCsumQty"   , index: "calCsumQty"   , label: "칼로리 소모/일"          , width: 80 , align: "right"  ,fixed:true},
