    ...
    methods: {
        ...
        initGrid: function()
        {
            ...
            let colModels = [
                ...
                {name: "dgemTm"            , index: "dgemTm"            , label: "판정시각"           , width: 80     , align: "center" , fixed:  true , formatter: function(cellValue, options, rowObject) { if(WebUtil.isNull(cellValue)) return ''; else return formatTime(cellValue); }},
                ...
                {name: "stdtNm"            , index: "stdtNm"            , label: "학생명"             , width: 80     , align: "center" , fixed:  true , formatter: function(cellValue, options, rowObject){
                    if(WebUtil.isNull(cellValue)) return '<input type="button" class="btn btn-xs btn-outline btn-success" onclick="dgemHist.regStdtInfoDetlPopup(\'' + rowObject.stdtNo + '\', \'' + rowObject.guarNo + '\')" value="신규" data-toggle="modal" data-target="#stdtRegDetlPopup" />';
                    else return`<a data-toggle="modal" class="links" data-target="#stdtInfoDetlPopup" data-stdt data-placement="bottom" title="${cellValue}" data-guar-no="${rowObject.guarNo}" data-stdt-no="${rowObject.stdtNo}">${cellValue}</a>`;}},
                ...
                {name: "dgemSmryCntn"      , index: "dgemSmryCntn"      , label: "위험감정 요약내용"  , width: 150    , align: "left"   , fixed:  true},
                {name: "dgemStatCntn"      , index: "dgemStatCntn"      , label: "위험감정 상세내용"  , width: 200    , align: "left"   , fixed:  true},
...
/*              {name: "currLatVal"        , index: "currLatVal"        , label: "현재위도 값"        , width: 80     , align: "center" , fixed:  true},
                ...
                {name: "actDivCd"          , index: "actDivCd"          , label: "활동구분"           , width: 100    , align: "center" , fixed:  true},
                {name: "hbitStatCd"        , index: "hbitStatCd"        , label: "심박상태"           , width: 100    , align: "center" , fixed:  true},
                {name: "plcClssCd"         , index: "plcClssCd"         , label: "장소분류"           , width: 110    , align: "center" , fixed:  true},
                {name: "tempStatCd"        , index: "tempStatCd"        , label: "온도상태"           , width: 110    , align: "center" , fixed:  true},
