let fatJudgStndDetl = new Vue({
    ...
    methods: {
        ...
        initPage: function(fatJudgCd) {
        	
        	let $this = this;
        	$this.resetFatJudgStndInfo();

        	
        	if ( !WebUtil.isNull(fatJudgCd) )
    		{
        		let params = {
        			'fatJudgCd' : fatJudgCd
        		}
        		...
        		AjaxUtil.post({
                    url: "/svcStnd/fat/fatJudgStndMng/searchFatJudgStndInfo.ab",
                    param: params,
        ...
        isValid: function() {
        	...
        	if ( WebUtil.isNull($this.fatJudgStndInfo.fatJudgCd) ) {
